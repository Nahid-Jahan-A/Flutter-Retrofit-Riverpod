...
class _$MetaImpl implements _Meta {
  const _$MetaImpl({required this.statusCode, this.message});
...
abstract class _Meta implements Meta {
  const factory _Meta({required final int statusCode, final String? message}) =
      _$MetaImpl;
...
abstract class _ApiResponse<T> implements ApiResponse<T> {
  const factory _ApiResponse(
      ...
      required final Meta meta}) = _$ApiResponseImpl<T>;
